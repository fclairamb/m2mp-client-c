...
${OBJECTDIR}/_ext/1360937237/logging.o: ../src/logging.c 
	...
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/logging.o ../src/logging.c

${OBJECTDIR}/_ext/1360937237/m2mp_client.o: ../src/m2mp_client.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/m2mp_client.o ../src/m2mp_client.c

${OBJECTDIR}/_ext/1360937237/str.o: ../src/str.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/str.o ../src/str.c

${OBJECTDIR}/_ext/1360937237/memwatcher.o: ../src/memwatcher.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/memwatcher.o ../src/memwatcher.c

${OBJECTDIR}/_ext/1360937237/m2mp_client_settings.o: ../src/m2mp_client_settings.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/m2mp_client_settings.o ../src/m2mp_client_settings.c

${OBJECTDIR}/_ext/1360937237/m2mp_client_files.o: ../src/m2mp_client_files.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/m2mp_client_files.o ../src/m2mp_client_files.c

${OBJECTDIR}/_ext/1360937237/dictionnary.o: ../src/dictionnary.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/dictionnary.o ../src/dictionnary.c

${OBJECTDIR}/_ext/1360937237/m2mp_client_commands.o: ../src/m2mp_client_commands.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/m2mp_client_commands.o ../src/m2mp_client_commands.c

${OBJECTDIR}/_ext/1360937237/linkedlist.o: ../src/linkedlist.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.c) -Werror -DNDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/linkedlist.o ../src/linkedlist.c
